...
TEST_CASE("reflex::constant_string: string array")
{
  ...
  // static constexpr std::string_view hello_world = constant_string{std::format("hello {}",
  // "world")}; static_assert(hello_world == "hello world"); static constexpr auto tmp2 =
  // std::array{"hello"_sc, "world"_sc}; static constexpr auto tmp3 = define_static_array(tmp2);
